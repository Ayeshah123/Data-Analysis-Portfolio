...
| [Credit Risk Analysis](https://github.com/Ayeshah123/Excel-FinalProject-CreditRiskAnalysis) | June 2026 | Analyzed customer demographics, financial behavior, employment patterns, and loan characteristics to identify factors associated with credit risk. Cleaned and transformed the data, created categorized segments and PivotTables, and developed three Excel dashboards to analyze credit risk across customer, employment, and loan dimensions. | Excel |
